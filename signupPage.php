...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["firstName"]) OR empty($_POST["lastName"])){ //test for input in the input box: firstName or lastName; this process is repeated for all variables
        $nameErr = "* Plase enter your name"; //display corresponding error message; this process is repeated for all variables
    }
    else{
        $firstName = test_input($_POST["firstName"]); //associate the variable $firstName with the input; this process is repeated for all variables
            ...
            if (empty($_POST["email"])){
                ...
                elseif(empty($_POST["password"])) {
                    ...
                    if (mysqli_num_rows($result1) === 1) {
                        ...
                        $sql3 ="INSERT INTO `user`(`User_id`, `First_name`, `Last_name`, `Password`, `Email`, `Account_type`)"." VALUES ('$userID','$firstName','$lastName','$password','$email','2')"; //creating a new database entry in user
