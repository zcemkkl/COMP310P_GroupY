...
<div class="YourOrders">
    ...
    $sql = "SELECT `event`.Title, show_details.Venue, show_details.Start_time, show_details.End_time, show_details.date, sales.Tickets_brought, `event`.`Event_id` FROM `event`
...
<td>'. $row['End_time'].'</td>
<td>'. $row['date'].'</td>
<td>'. $row['Tickets_brought'].'</td>
<td>'.'<a href = emailSent.php>send email</a>'.'</td>
